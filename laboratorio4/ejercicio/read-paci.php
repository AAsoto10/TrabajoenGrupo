...
<body>
 ...
 while($row=mysqli_fetch_array($resultado)){
    ...
    <tr>
        ...
        <td>
            <a href="javascript:formEditarPaciente(<?php echo $row['id'];?>)">Editar</a>
            <a href="javascript:eliminarPaciente(<?php echo $row['id'];?>)">Eliminar</a> 
            <a href="javascript:cargarContenido('form-paciente.html')"> Insertar</a>
        </td>
    </tr>
    <?php } ?>
 </table>
